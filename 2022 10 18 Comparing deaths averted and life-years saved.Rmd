...
The number of available vaccine doses are varied from 0 to 60 million in steps of 5 million:
...
Using these vaccine uptake levels and risk of mortality, the number of deaths averted are plotted against the total number of available doses, following the one-dose only and two-dose only allocation strategies.

```{r, echo=FALSE, fig.cap = "Figure 1. Number of deaths averted following the one-dose and two-dose SARS-CoV-2 vaccination strategies, versus the number of available doses. The blue lines correspond to the one-dose strategy, and the red lines correspond to the two-dose strategy, with a range of vaccine efficacies considered for each strategy."}
...
*Figures 2(a) - (m)* below show the proportions of each priority group that have been vaccinated following the one-dose only and two-dose only allocation strategies, with a total number of available doses ranging from 0 to 60 million.

```{r, echo=FALSE, fig.cap = "Figures 2(a) - (m). Proportions of each priority group that have been vaccinated following the one-dose only and two-dose only allocation strategies, with a total number of available doses ranging from 0 to 60 million. The blue bars correspond to the one-dose only strategy, and the red bars correspond to the two-dose only strategy."}
...
*Figure 4a* shows the number of life-years saved with lower numbers of available doses - up to four million. Life-years saved are plotted against the total number of available doses, following the one-dose only and two-dose only allocation strategies. At around 1.5 million doses,  with a second-dose vaccine efficacy of 99% and a first-dose efficacy of 70%, the two-dose strategy briefly takes over as the optimal strategy. It then switches back at around 3 million doses to the one-dose strategy.

*Figure 4b* shows the number of life-years saved following each vaccination strategy with up to 60 million available doses.

```{r, echo=FALSE, fig.cap = "Figures 4a-b. Number of life-years saved following the one-dose only and two-dose only SARS-CoV-2 vaccination strategies, versus the number of available doses. The blue lines correspond to the one-dose strategy, and the red lines correspond to the two-dose strategy, with a range of vaccine efficacies considered for each strategy."}
...
plot(1, type="n", xlab="Doses available (millions)", ylab="Life-years saved",xlim=c(0, 4), ylim = c(0, 250000))
...
plot(1, type="n", xlab="Doses available (millions)", ylab="Life-years saved",xlim=c(0, 60), ylim = c(0, 1200000))
